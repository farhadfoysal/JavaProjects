...
public class Main extends JFrame implements ChangeListener, ActionListener, ItemListener, KeyListener, MouseListener, MouseMotionListener, WindowListener, FocusListener, WindowFocusListener, MouseWheelListener, WindowStateListener{
	...
	Main(){
		this.setDefaultCloseOperation(Main.DISPOSE_ON_CLOSE);
...
//		timer.scheduleAtFixedRate(task,delay,interval);
	...
	Main(String name, String id , String sId, String phone, String pass, String email){
		this.setDefaultCloseOperation(Main.DISPOSE_ON_CLOSE);
		this.setBounds(150,50,1080,680);
		this.setResizable(true);
		this.setTitle("FF_ADMIN_PANEL");
